...
class ServerClientProcess extends Thread { // thread for Server to Client communication
    ...
    public ServerClientProcess(Socket clientSocket, ArrayList<MessageInfo> messageInfo, 
            ...
            throws IOException {
        System.out.println("Connected to Client on port " + clientSocket.getPort() + " with my local " + clientSocket.getLocalPort());
        this.messageInfo = messageInfo;
        this.bChanged = bChanged;
    ...
    public void run() {
        while (true) {
            MessageInfo message = receiveMessage();
            System.out.println("Message from client: " + message);
            message.messageConsistencyID = messageInfo.size();
